...
LOGGING_NAME = 'GoToPreview'


class GoToPreviewNode(Node):

    def __init__(self, namespace: str = ""):
        super().__init__('goto_preview_sub')
        self.preview_sub = self.create_subscription(
            GoToPreview, f'/{namespace}/autonomy_previewer/goto/preview', self.preview_cb, 10)
...
def main(args=None):
    ...
    preview_sub = GoToPreviewNode(namespace)
